export const parser = // Generated by Peggy 3.0.2.
  ...
  (function () {
    ...
    function peg$parse(input, options) {
      ...
      var peg$e17 = peg$otherExpectation('[min..max]')
      ...
      var peg$f6 = function (op, number) {
        return { type: 'compare', op, value: number }
      }
      var peg$f7 = function (type, value) {
      ...
      var peg$f11 = function (chars) {
        return { type: 'term', value: chars.join('') }
      }
      var peg$currPos = 0
      var peg$savedPos = 0
