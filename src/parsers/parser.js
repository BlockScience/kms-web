export const parser = // Generated by Peggy 3.0.2.
  ...
  (function () {
    ...
    function peg$parse(input, options) {
      ...
      var peg$startRuleFunctions = { Filter: peg$parseFilter }
      var peg$startRuleFunction = peg$parseFilter
      ...
      var peg$e10 = peg$otherExpectation('word')
      var peg$e11 = peg$classExpectation(['\\', 's', ':', ','], true, false)
      ...
      var peg$f0 = function (exps) {
        return exps
      }
      var peg$f1 = function (head, tail) {
        return { type: 'or', expressions: [head, ...tail.map((t) => t[3])] }
      }
      var peg$f2 = function (head, tail) {
        return { type: 'and', expressions: [head, ...tail.map((t) => t[3])] }
      }
      var peg$f3 = function (key, condition) {
        return { key, condition }
      }
      var peg$f4 = function (values) {
        return {
          type: 'values',
          values: [values[0], ...values[2].map((v) => v[3])],
        }
      }
      ...
      var peg$f7 = function (values) {
        return { type: 'not', values }
      }
      var peg$f8 = function (min, max) {
        return { type: 'range', min, max }
      }
      var peg$f9 = function (ranges) {
        return {
          type: 'ranges',
          ranges: ranges.map((r) => ({ min: r[0], max: r[2] })),
        }
      }
      ...
      function peg$parseConditions() {
        ...
        s0 = peg$parseValues()
        if (s0 === peg$FAILED) {
          s0 = peg$parseExactValue()
          if (s0 === peg$FAILED) {
            s0 = peg$parseNegatedValue()
            if (s0 === peg$FAILED) {
              s0 = peg$parseRange()
              if (s0 === peg$FAILED) {
                s0 = peg$parseRanges()
